...
clf_with = ensemble.RandomForestClassifier(n_estimators=100, min_samples_split=500, n_jobs=-1, max_depth=100).fit(with_features, with_labels.values.ravel())
clf_wo = ensemble.RandomForestClassifier(n_estimators=100, min_samples_split=500, n_jobs=-1, max_depth=100).fit(wo_features, wo_labels.values.ravel())
#clf - BernoulliNB()
